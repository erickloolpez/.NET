...
namespace APIFront.APIPlan {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="Api_GestionPlanSoap", Namespace="http://tempuri.org/")]
    public partial class Api_GestionPlan : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Api_GestionPlan() {
            this.Url = global::APIFront.Properties.Settings.Default.APIFront_APIPlan_Api_GestionPlan;
        ...
        public planes[] ListarFiltro(string info) {
        ...
        /// <remarks/>
        public void InsertarAsync(planes plan_nuevo) {
            this.InsertarAsync(plan_nuevo, null);
        }
        
        /// <remarks/>
        public void InsertarAsync(planes plan_nuevo, object userState) {
            ...
            this.InvokeAsync("Insertar", new object[] {
                        plan_nuevo}, this.InsertarOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void ActualizarAsync(planes plan_actualizado) {
            this.ActualizarAsync(plan_actualizado, null);
        }
        
        /// <remarks/>
        public void ActualizarAsync(planes plan_actualizado, object userState) {
            ...
            this.InvokeAsync("Actualizar", new object[] {
                        plan_actualizado}, this.ActualizarOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void EliminarAsync(planes plan_eliminado) {
            this.EliminarAsync(plan_eliminado, null);
        }
        
        /// <remarks/>
        public void EliminarAsync(planes plan_eliminado, object userState) {
            ...
            this.InvokeAsync("Eliminar", new object[] {
                        plan_eliminado}, this.EliminarOperationCompleted, userState);
        }
    ...
    public partial class ListarCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public planes[] Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((planes[])(this.results[0]));
            }
        }
    }
